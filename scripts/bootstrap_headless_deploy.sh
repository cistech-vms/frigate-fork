...
upsert_env "FRIGATE_IMAGE" "frigate:local-tensorrt"
upsert_env "FRIGATE_GPU_DEVICE" "0"
...
echo "- Proximo passo 1: bash scripts/export_yolov9_onnx.sh"
echo "- Proximo passo 2: bash scripts/build_local_tensorrt_image.sh"
echo "- Proximo passo 3: docker compose -f docker-compose.prod.yml up -d"
